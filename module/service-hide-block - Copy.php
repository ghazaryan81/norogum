		...
		<ul class="services-block-list">
				...
				<div class="services-block-title">
					<div class="services-block-title-pad">
						<spn class="services-block-title-txt">
							<img src="img/service-icon-1.png" alt="" title="" width="25" class="service-list-icon-img" />
			...
			<li class="services-block-list-item">
				...
				<div class="services-block-title">
					<div class="services-block-title-pad">
						<spn class="services-block-title-txt">
							<img src="img/service-icon-2.png" alt="" title="" width="25" class="service-list-icon-img" />
							ЭЛЕКТРОНИКА
						</spn>
					</div>
				</div>
			...
			<li class="services-block-list-item">
				...
				<div class="services-block-title">
					<div class="services-block-title-pad">
						<spn class="services-block-title-txt">
							<img src="./img/service-icon-3.png" alt="" title="" width="25" class="service-list-icon-img" />
